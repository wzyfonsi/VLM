...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            # 把其他的部分全部替换成padding_token_id，因为在训练的时候指定了不计算pad_token_id的损失
...
if __name__ == '__main__':
    config = VLMConfig()
    processor = AutoProcessor.from_pretrained("E:\Python\Workspace\Multi-Model\Model\siglip-base-patch16-224")
